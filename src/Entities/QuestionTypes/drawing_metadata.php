 ...
 */
class drawing_metadata extends BaseQuestionTypeAttribute {
    ...
    /**
     * Get Distractors \
     * Used to store the distractor rationales that map to responses in the same order for use/rendering by the host environmen
	 * t. \
