...
class customfeature extends BaseQuestionType {
    ...
    /**
     * Get JavaScript file \
     * A URL to a JavaScript file which defines an AMD module for the feature. See this <a href="https://docs.learnosity.com/as
	 * sessment/questions/knowledgebase/customfeatures">knowledgebase article</a> for more information. \
     * @return string $js \
     */
