...
class choicematrix_validation extends BaseQuestionTypeAttribute {
    ...
    * The way in which marks are distributed for the question. Possible options:<br><strong>'exactMatch'</strong>: Exact Match
	...
	l Match - Each correct response element will be scored individually, and the overall question score will be divided betw
	een responses.<br><strong>'partialMatch'</strong>: Partial Match per Response - Each correct response element will be aw
	arded an individual score. \
