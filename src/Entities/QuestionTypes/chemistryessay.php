...
class chemistryessay extends BaseQuestionType {
     ...
     * @return chemistryessay_response_container $response_container \
     */
     ...
     * Object that defines styles for the response container. \
     * @param chemistryessay_response_container $response_container \
     */
    public function set_response_container (chemistryessay_response_container $response_container) {
