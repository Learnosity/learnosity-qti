...
*/
class gridded extends BaseQuestionType {
    protected $is_math;
    protected $metadata;
    protected $stimulus;
    ...
    * Get metadata \
    *  \
    * @return gridded_metadata $metadata \
    */
    ...
    * Set metadata \
    *  \
    * @param gridded_metadata $metadata \
    */
    public function set_metadata (gridded_metadata $metadata) {
    ...
    * Get ui_style \
    *  \
    * @return gridded_ui_style $ui_style \
    */
    ...
    * Set ui_style \
    *  \
    * @param gridded_ui_style $ui_style \
    */
    public function set_ui_style (gridded_ui_style $ui_style) {
    ...
    * @return gridded_validation $validation \
    */
    ...
    * In this section, configure the correct answer(s) for the question. \
    * @param gridded_validation $validation \
    */
    public function set_validation (gridded_validation $validation) {
    ...
    * @return gridded_options $options \
    */
    ...
    * Set Options \
    * Settings for the question. \
    * @param gridded_options $options \
    */
    public function set_options (gridded_options $options) {
