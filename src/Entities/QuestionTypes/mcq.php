...
It <a data-toggle="modal" href="#supportedTags">supports HTML entities</a>. \
     ...
     * A list of possible responses for the student to select the correct answer(s) from. \
     ...
     * The student will be able to select more than one answer, when this option is enabled. Also when this option is enabled, 
	 * author can set <code>min_selection</code> and <code>max_selection</code> to control the allowed minimum and maximum resp
	 * onses. \
    ...
    /**
     * Get Shuffle options \
     * When this is enabled, the response options will display in a different order each time the question is rendered. \
    ...
    /**
     * Get Minimum number of responses \
     * Defines how many options should be selected at least when giving an answer. 0 means an unlimited amount. \
     * @return number $min_selection \
     */
    public function get_min_selection() {
        return $this->min_selection;
    }

    /**
     * Set Minimum number of responses \
     * Defines how many options should be selected at least when giving an answer. 0 means an unlimited amount. \
     * @param number $min_selection \
     */
    public function set_min_selection ($min_selection) {
        $this->min_selection = $min_selection;
    }

    /**
     * Get Maximum number of responses \
     * Defines how many options can be selected at most when giving an answer. 0 means an unlimited amount. \
