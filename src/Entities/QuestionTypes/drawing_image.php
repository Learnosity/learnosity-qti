 ...
 */
class drawing_image extends BaseQuestionTypeAttribute {
    protected $source;
    protected $alt;
    protected $width;
    protected $height;
     ...
     * Alternative text that appears when the image cannot be rendered, and is used for accessibility purposes such as screen r
	 * eaders. \
     * @return textarea $alt \
     */
