...
class simplechart extends BaseQuestionType {
     ...
     * @return string/number $snap_to_grid \
     */
     ...
     * Set Snap to grid \
     * Specify snap to grid threshold. Snap to grid is disabled if set to 0 or if the tick format is float. \
     * @param string/number $snap_to_grid \
     */
    ...
    /**
     * Get Convert slashes to stacked fractions \
     * If checked, x-axis labels with numeric linear (slashed) fractions will be displayed as a stacked fraction with a vinculu
	 * m (horizontal bar). Non numeric text will be stripped from the label. \
     * @return boolean $stacked_fraction \
     */
    public function get_stacked_fraction() {
        return $this->stacked_fraction;
    }

    /**
     * Set Convert slashes to stacked fractions \
     * If checked, x-axis labels with numeric linear (slashed) fractions will be displayed as a stacked fraction with a vinculu
	 * m (horizontal bar). Non numeric text will be stripped from the label. \
     * @param boolean $stacked_fraction \
     */
    public function set_stacked_fraction ($stacked_fraction) {
        $this->stacked_fraction = $stacked_fraction;
    }
