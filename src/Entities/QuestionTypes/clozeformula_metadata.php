...
class clozeformula_metadata extends BaseQuestionTypeAttribute {
    ...
    /**
     * Get Distractors \
     * Used to display individual response feedback/rationale to the learner, at the relevant response level. Note that this is
	 *  a premium Learnosity feature, contact Learnosity support to have it enabled. \
