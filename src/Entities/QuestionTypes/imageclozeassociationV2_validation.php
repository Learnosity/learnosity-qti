 ...
 */
class imageclozeassociationV2_validation extends BaseQuestionTypeAttribute {
	 ...
	 * t match exactly<br><strong>'partialMatchV2'</strong>: Partial Match - A relative part of the score will be given for eac
	 * h correct response area<br><strong>'partialMatch'</strong>: Partial Match per response - Cumulative Score value will be 
     ...
     * @return imageclozeassociationV2_validation_valid_response $valid_response \
     */
     ...
     * Set Valid response \
     * An object containing the valid response score and value. \
     * @param imageclozeassociationV2_validation_valid_response $valid_response \
     */
    public function set_valid_response (imageclozeassociationV2_validation_valid_response $valid_response) {
