 ...
 */
class video extends BaseQuestionType {
    protected $is_math;
    protected $metadata;
    protected $stimulus;
     ...
     * Set metadata \
     *  \
     * @param video_metadata $metadata \
     */
    public function set_metadata (video_metadata $metadata) {
     ...
     * Get ui_style \
     *  \
     * @return video_ui_style $ui_style \
     */
     ...
     * Set ui_style \
     *  \
     * @param video_ui_style $ui_style \
     */
    public function set_ui_style (video_ui_style $ui_style) {
     ...
     * @return video_validation $validation \
     */
     ...
     * Set Validation \
     * In this section, configure the correct answer(s) for the question. \
     * @param video_validation $validation \
     */
    public function set_validation (video_validation $validation) {
        $this->validation = $validation;
    }

    /**
     * Get Maximum length (seconds) \
     * The length of video, in seconds, allowed to be recorded by the student. Maximum value and default value is 600 (10 minut
	 * es) \
