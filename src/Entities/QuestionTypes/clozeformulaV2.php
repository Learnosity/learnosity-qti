 ...
 */
class clozeformulaV2 extends BaseQuestionType {
     ...
     * Get metadata \
     *  \
     * @return clozeformulaV2_metadata $metadata \
     */
     ...
     * Set metadata \
     *  \
     * @param clozeformulaV2_metadata $metadata \
     */
    public function set_metadata (clozeformulaV2_metadata $metadata) {
     ...
     * Get ui_style \
     *  \
     * @return clozeformulaV2_ui_style $ui_style \
     */
     ...
     * Set ui_style \
     *  \
     * @param clozeformulaV2_ui_style $ui_style \
     */
    public function set_ui_style (clozeformulaV2_ui_style $ui_style) {
     ...
     * @return clozeformulaV2_validation $validation \
     */
     ...
     * In this section, configure the correct answer(s) for the question. \
     * @param clozeformulaV2_validation $validation \
     */
    public function set_validation (clozeformulaV2_validation $validation) {
     ...
     * @return clozeformulaV2_response_container $response_container \
     */
     ...
     * Define the template and dimensions for all response containers. \
     * @param clozeformulaV2_response_container $response_container \
     */
    public function set_response_container (clozeformulaV2_response_container $response_container) {
     ...
     *  \
     * @return clozeformulaV2_hints $hints \
     */
     ...
     *  \
     * @param clozeformulaV2_hints $hints \
     */
    public function set_hints (clozeformulaV2_hints $hints) {
        $this->hints = $hints;
    }
