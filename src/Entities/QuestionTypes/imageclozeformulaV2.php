 ...
 */
class imageclozeformulaV2 extends BaseQuestionType {
    ...
    protected $numberPad;
    protected $symbols;
    protected $math_image_capture;
    
    public function __construct(
                    $type,
                                array $response_containers,
                                imageclozeformulaV2_image $image,
     ...
     * Get metadata \
     *  \
     * @return imageclozeformulaV2_metadata $metadata \
     */
     ...
     * Set metadata \
     *  \
     * @param imageclozeformulaV2_metadata $metadata \
     */
    public function set_metadata (imageclozeformulaV2_metadata $metadata) {
     ...
     * Get ui_style \
     *  \
     * @return imageclozeformulaV2_ui_style $ui_style \
     */
     ...
     * Set ui_style \
     *  \
     * @param imageclozeformulaV2_ui_style $ui_style \
     */
    public function set_ui_style (imageclozeformulaV2_ui_style $ui_style) {
     ...
     * @return imageclozeformulaV2_validation $validation \
     */
     ...
     * In this section, configure the correct answer(s) for the question. \
     * @param imageclozeformulaV2_validation $validation \
     */
    public function set_validation (imageclozeformulaV2_validation $validation) {
    ...
    /**
     * Get is_dynamic_content \
     * This attribute will be set to true when the Question has been created by the Math Question Generator. \
     * @return boolean $is_dynamic_content \
     */
    public function get_is_dynamic_content() {
        return $this->is_dynamic_content;
    }

    /**
     * Set is_dynamic_content \
     * This attribute will be set to true when the Question has been created by the Math Question Generator. \
     * @param boolean $is_dynamic_content \
     */
    public function set_is_dynamic_content ($is_dynamic_content) {
        $this->is_dynamic_content = $is_dynamic_content;
    }
     ...
     * @return imageclozeformulaV2_response_container $response_container \
     */
     ...
     * Define the template and dimensions for all response containers. \
     * @param imageclozeformulaV2_response_container $response_container \
     */
    public function set_response_container (imageclozeformulaV2_response_container $response_container) {
        $this->response_container = $response_container;
    }

    /**
     * Get Provide step-by-step instructions to learners to help them solve a question \
     *  \
     * @return imageclozeformulaV2_hints $hints \
     */
    ...
    /**
     * Set Provide step-by-step instructions to learners to help them solve a question \
     *  \
     * @param imageclozeformulaV2_hints $hints \
     */
    public function set_hints (imageclozeformulaV2_hints $hints) {
        $this->hints = $hints;
    }
     ...
     * Get Display Hints \
     *  \
     * @return boolean $show_hints_button \
     */
    public function get_show_hints_button() {
        return $this->show_hints_button;
    }

    /**
     * Set Display Hints \
     *  \
     * @param boolean $show_hints_button \
     */
    public function set_show_hints_button ($show_hints_button) {
        $this->show_hints_button = $show_hints_button;
    }
     ...
     * @return imageclozeformulaV2_image $image \
     */
     ...
     * Set Image settings \
     * Image settings are defined here. \
     * @param imageclozeformulaV2_image $image \
     */
    public function set_image (imageclozeformulaV2_image $image) {
        $this->image = $image;
    }
    ...
    /**
     * Get Enable image capture \
     * Allow the learner to enter their response by capturing an image of handwritten math. \
     * @return boolean $math_image_capture \
     */
    public function get_math_image_capture() {
        return $this->math_image_capture;
    }

    /**
     * Set Enable image capture \
     * Allow the learner to enter their response by capturing an image of handwritten math. \
     * @param boolean $math_image_capture \
     */
    public function set_math_image_capture ($math_image_capture) {
        $this->math_image_capture = $math_image_capture;
    }
