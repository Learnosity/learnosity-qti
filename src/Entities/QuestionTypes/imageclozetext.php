...
class imageclozetext extends BaseQuestionType {
    ...
    protected $ignore_leading_and_trailing_spaces;
...
If an Array, the character map button will s
    ...
    /**
     * Get Ignore leading and trailing spaces \
     * Determines whether the automatic marking will ignore leading and trailing spaces. E.g. 'a' and ' a ' will be treated as 
	 * the same. \
     * @return boolean $ignore_leading_and_trailing_spaces \
     */
    public function get_ignore_leading_and_trailing_spaces() {
        return $this->ignore_leading_and_trailing_spaces;
    }

    /**
     * Set Ignore leading and trailing spaces \
     * Determines whether the automatic marking will ignore leading and trailing spaces. E.g. 'a' and ' a ' will be treated as 
	 * the same. \
     * @param boolean $ignore_leading_and_trailing_spaces \
     */
    public function set_ignore_leading_and_trailing_spaces ($ignore_leading_and_trailing_spaces) {
        $this->ignore_leading_and_trailing_spaces = $ignore_leading_and_trailing_spaces;
    }
