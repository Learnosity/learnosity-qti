 ...
 */
class multistepmath extends BaseQuestionType {
     ...
     * Get metadata \
     *  \
     * @return multistepmath_metadata $metadata \
     */
     ...
     * Set metadata \
     *  \
     * @param multistepmath_metadata $metadata \
     */
    public function set_metadata (multistepmath_metadata $metadata) {
     ...
     * Get ui_style \
     *  \
     * @return multistepmath_ui_style $ui_style \
     */
     ...
     * Set ui_style \
     *  \
     * @param multistepmath_ui_style $ui_style \
     */
    public function set_ui_style (multistepmath_ui_style $ui_style) {
     ...
     * @return multistepmath_validation $validation \
     */
     ...
     * In this section, configure the correct answer(s) for the question. \
     * @param multistepmath_validation $validation \
     */
    public function set_validation (multistepmath_validation $validation) {
     ...
     *  \
     * @return multistepmath_hints $hints \
     */
     ...
     *  \
     * @param multistepmath_hints $hints \
     */
    public function set_hints (multistepmath_hints $hints) {
        $this->hints = $hints;
    }
