...
*/
class tokenhighlight_validation extends BaseQuestionTypeAttribute {
    ...
    * @return tokenhighlight_validation_valid_response $valid_response \
    */
    ...
    * Set Valid response \
    * An object containing the valid response score and value. \
    * @param tokenhighlight_validation_valid_response $valid_response \
    */
    public function set_valid_response (tokenhighlight_validation_valid_response $valid_response) {
