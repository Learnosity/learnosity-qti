 ...
 */
class numberline_validation extends BaseQuestionTypeAttribute {
	 ...
	 * en responses.<br><strong>'partialMatch'</strong>: Partial Match per Response - Each correct response element will be awa
	 * rded an individual score. \
     ...
     * @return numberline_validation_valid_response $valid_response \
     */
     ...
     * Set Valid response \
     * An object containing the valid response score and value. \
     * @param numberline_validation_valid_response $valid_response \
     */
    public function set_valid_response (numberline_validation_valid_response $valid_response) {
