 ...
 */
class chemistryessayV2 extends BaseQuestionType {
    protected $is_math;
    protected $metadata;
    protected $stimulus;
     ...
     * Get metadata \
     *  \
     * @return chemistryessayV2_metadata $metadata \
     */
     ...
     * Set metadata \
     *  \
     * @param chemistryessayV2_metadata $metadata \
     */
    public function set_metadata (chemistryessayV2_metadata $metadata) {
     ...
     * Get ui_style \
     *  \
     * @return chemistryessayV2_ui_style $ui_style \
     */
     ...
     * Set ui_style \
     *  \
     * @param chemistryessayV2_ui_style $ui_style \
     */
    public function set_ui_style (chemistryessayV2_ui_style $ui_style) {
     ...
     * @return chemistryessayV2_validation $validation \
     */
     ...
     * Set Validation \
     * In this section, configure the correct answer(s) for the question. \
     * @param chemistryessayV2_validation $validation \
     */
    public function set_validation (chemistryessayV2_validation $validation) {
