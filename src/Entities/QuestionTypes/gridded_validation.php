...
*/
class gridded_validation extends BaseQuestionTypeAttribute {
    ...
    * @return gridded_validation_valid_response $valid_response \
    */
    ...
    * Set Valid response \
    * An object containing the valid response score and value. \
    * @param gridded_validation_valid_response $valid_response \
    */
    public function set_valid_response (gridded_validation_valid_response $valid_response) {
