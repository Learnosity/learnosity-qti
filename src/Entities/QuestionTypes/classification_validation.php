...
class classification_validation extends BaseQuestionTypeAttribute
{
     ...
     * t match exactly<br><strong>'partialMatchV2'</strong>: Partial Match per cell - max score - A relative part of the score
     * will be given for each correct response area<br><strong>'partialMatch'</strong>: Partial Match per cell - Cumulative Sco
     * re value will be given for each correct response area<br><strong>'partialMatchElement'</strong>: Partial Match per eleme
