...
*/
class tokenhighlight extends BaseQuestionType {
    protected $is_math;
    protected $metadata;
    protected $stimulus;
    ...
    * Get metadata \
    *  \
    * @return tokenhighlight_metadata $metadata \
    */
    ...
    * Set metadata \
    *  \
    * @param tokenhighlight_metadata $metadata \
    */
    ...
    * Get ui_style \
    *  \
    * @return tokenhighlight_ui_style $ui_style \
    */
    ...
    * Set ui_style \
    *  \
    * @param tokenhighlight_ui_style $ui_style \
    */
    public function set_ui_style (tokenhighlight_ui_style $ui_style) {
    ...
    * @return tokenhighlight_validation $validation \
    */
    ...
    * Set validation \
    * Validation object that includes options on how this question will be automarked \
    * @param tokenhighlight_validation $validation \
    */
    public function set_validation (tokenhighlight_validation $validation) {
    ...
    */
    ...
    /**
    * Get tokenization \
    * This need to always be set to `custom` \
    * @return string $tokenization \
    */
    public function get_tokenization() {
    ...
    * Set tokenization \
    * This need to always be set to `custom` \
    * @param string $tokenization \
    */
    public function set_tokenization ($tokenization) {
        $this->tokenization = $tokenization;
    }
