...
class imageclozeassociationV2 extends BaseQuestionType {
    ...
    protected $max_response_per_zone;
    ...
    public function __construct(
                    $type,
                                ...
                                imageclozeassociationV2_image $image,
     ...
     * Get metadata \
     *  \
     * @return imageclozeassociationV2_metadata $metadata \
     */
     ...
     * Set metadata \
     *  \
     * @param imageclozeassociationV2_metadata $metadata \
     */
     ...
     * Get ui_style \
     *  \
     * @return imageclozeassociationV2_ui_style $ui_style \
     */
     ...
     * Set ui_style \
     *  \
     * @param imageclozeassociationV2_ui_style $ui_style \
     */
     ...
     * @return imageclozeassociationV2_validation $validation \
     */
     ...
     * In this section, configure the correct answer(s) for the question. \
     * @param imageclozeassociationV2_validation $validation \
     */
     ...
     * @return imageclozeassociationV2_response_container $response_container \
     */
     ...
     * Use Response Container (global) to make changes to all response boxes at once. \
     * @param imageclozeassociationV2_response_container $response_container \
     */
     ...
     * @return imageclozeassociationV2_image $image \
     */
     ...
     * Set Image settings \
     * Image settings are defined here. \
     * @param imageclozeassociationV2_image $image \
     */
    ...
    /**
     * Get Maximum responses per container \
     * Maximum number of responses allowed to be dropped per container. \
     * @return number $max_response_per_zone \
     */
    public function get_max_response_per_zone() {
        return $this->max_response_per_zone;
    }

    /**
     * Set Maximum responses per container \
     * Maximum number of responses allowed to be dropped per container. \
     * @param number $max_response_per_zone \
     */
    public function set_max_response_per_zone ($max_response_per_zone) {
        $this->max_response_per_zone = $max_response_per_zone;
    }
