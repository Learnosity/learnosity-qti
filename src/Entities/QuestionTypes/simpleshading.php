...
class simpleshading extends BaseQuestionType {
    ...
    protected $hover;
    protected $canvas;
    protected $canvas_container_style;
    ...
    /**
     * Get Canvas container style \
     * Set the canvas container style. \
     * @return canvasContainerStyle $canvas_container_style \
     */
    public function get_canvas_container_style() {
        return $this->canvas_container_style;
    }

    /**
     * Set Canvas container style \
     * Set the canvas container style. \
     * @param canvasContainerStyle $canvas_container_style \
     */
    public function set_canvas_container_style ($canvas_container_style) {
        $this->canvas_container_style = $canvas_container_style;
    }
