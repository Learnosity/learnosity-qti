...
*/
class sortlist_validation extends BaseQuestionTypeAttribute {
    protected $penalty;
    ...
    * @return sortlist_validation_valid_response $valid_response \
    */
    ...
    * Set Valid response \
    * An object containing the valid response score and value. \
    * @param sortlist_validation_valid_response $valid_response \
    */
    public function set_valid_response (sortlist_validation_valid_response $valid_response) {
