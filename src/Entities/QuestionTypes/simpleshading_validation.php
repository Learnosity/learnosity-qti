...
*/
class simpleshading_validation extends BaseQuestionTypeAttribute {
    ...
    * The way in which marks are distributed for the question. Possible options:<br><strong>'exactMatch'</strong>: Exact Match
	 - All parts of the question must be answered correctly to receive a mark. <br><strong>'partialMatchV2'</strong>: Partia
	l Match - Each correct cell will be scored individually, and the overall question score will be divided between the amou
	nt of correct cells. \
    * @return string $scoring_type ie. exactMatch, partialMatchV2  \
    */
    ...
    * The way in which marks are distributed for the question. Possible options:<br><strong>'exactMatch'</strong>: Exact Match
	...
	l Match - Each correct cell will be scored individually, and the overall question score will be divided between the amou
	nt of correct cells. \
    * @param string $scoring_type ie. exactMatch, partialMatchV2  \
    */
    ...
    * @return simpleshading_validation_valid_response $valid_response \
    */
    ...
    * Set Valid response \
    * An object containing the valid response score and value. \
    * @param simpleshading_validation_valid_response $valid_response \
    */
    public function set_valid_response (simpleshading_validation_valid_response $valid_response) {
