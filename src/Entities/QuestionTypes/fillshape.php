...
*/
class fillshape extends BaseQuestionType {
    protected $is_math;
    protected $metadata;
    protected $stimulus;
    ...
    * Get metadata \
    *  \
    * @return fillshape_metadata $metadata \
    */
    ...
    * Set metadata \
    *  \
    * @param fillshape_metadata $metadata \
    */
    public function set_metadata (fillshape_metadata $metadata) {
    ...
    * Get ui_style \
    *  \
    * @return fillshape_ui_style $ui_style \
    */
    ...
    * Set ui_style \
    *  \
    * @param fillshape_ui_style $ui_style \
    */
    public function set_ui_style (fillshape_ui_style $ui_style) {
    ...
    * @return fillshape_validation $validation \
    */
    ...
    * In this section, configure the correct answer(s) for the question. \
    * @param fillshape_validation $validation \
    */
    public function set_validation (fillshape_validation $validation) {
    ...
    * Set Shape \
    * The data of the built shape. \
    * @param fillshape_shape $shape \
    */
    public function set_shape (fillshape_shape $shape) {
        $this->shape = $shape;
    }

    /**
    * Get Possible responses \
    * An array of attributes for each draggable response. \
