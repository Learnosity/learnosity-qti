...
class rating extends BaseQuestionType {
     ...
     * @return boolean $hide_info_icon \
     */
    public function get_hide_info_icon() {
        return $this->hide_info_icon;
    }

    /**
     * Set Hide info icon \
     * When enabled, this option hides the information button next to the rating options that have been set. \
     * @param boolean $hide_info_icon \
     */
    public function set_hide_info_icon ($hide_info_icon) {
        $this->hide_info_icon = $hide_info_icon;
    }
