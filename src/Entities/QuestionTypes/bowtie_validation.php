 ...
 */
class bowtie_validation extends BaseQuestionTypeAttribute {
    ...
    /**
     * Get Scoring type \
     * The way in which marks are distributed for the question.<ul><li><strong>Exact Match</strong> - All parts of the question
	 *  must be answered correctly to receive a mark.</li><li><strong>Partial Match Per Cell</strong> - Each correct cell will 
	 * be scored will be awarded an individual score.</li><li><strong>Partial Match Per Cell - Max Score</strong> - Each correc
	 * t cell will be scored individually, and the overall question score will be divided between cells.</li><li><strong>Partia
	 * l match Per Element</strong> - Each correct response element will be awarded an individual score.</li><li><strong>Partia
	 * l Match per Element V2</strong> - Each correct response element will be scored individually, and the overall question sc
	 * ore will be divided between responses.</li></ul> \
     * @return string $scoring_type ie. exactMatch, partialMatchElement  \
     */
	 ...
	 * l Match per Element V2</strong> - Each correct response element will be scored individually, and the overall question sc
	 * ore will be divided between responses.</li></ul> \
     * @param string $scoring_type ie. exactMatch, partialMatchElement  \
     */
     ...
     * @return bowtie_validation_valid_response $valid_response \
     */
     ...
     * Set Valid response \
     * An object containing the valid response score and value. \
     * @param bowtie_validation_valid_response $valid_response \
     */
    public function set_valid_response (bowtie_validation_valid_response $valid_response) {
