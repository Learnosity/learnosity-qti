...
*/
class fillshape_validation extends BaseQuestionTypeAttribute {
    ...
    * @return fillshape_validation_valid_response $valid_response \
    */
    ...
    * Set Correct \
    * An object containing the valid response score and value. \
    * @param fillshape_validation_valid_response $valid_response \
    */
    public function set_valid_response (fillshape_validation_valid_response $valid_response) {
