...
class simplechart extends BaseQuestionType {
    ...
    */
    ...
    /**
    * Get Multicolour Bars \
    * Enables the ability to specify if the bars have different colours. Currently only supported by histogram. Order Point ha
	s to be disabled. \
