...
It <a data-toggle="modal" href="#supportedTags">support
    ...
    */
    ...
    /**
    * Get Line Colour Options \
    * Colour of the painted line, expressed as a HTML colour code. Examples of acceptable formats: '#FFFFFF', 'white', 'rgb(25
	5, 255, 255)', 'rgba(255, 0, 0, 0.8)'. \
